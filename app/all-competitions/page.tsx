...
import { Search, Trophy, Bell, Mail, MoreVertical } from "lucide-react"
...
export default function AllCompetitionsPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        {/* Sidebar Icons */}
        <aside className="w-16 bg-white border-r border-gray-200 min-h-screen">
          <div className="p-4">
            <div className="space-y-4">
              <Link
                href="/"
                className="flex items-center justify-center w-8 h-8 rounded-lg text-red-600 hover:bg-red-50"
              >
                <Trophy className="w-5 h-5" />
              </Link>
              <Link
                href="/grants"
                className="flex items-center justify-center w-8 h-8 rounded-lg text-gray-700 hover:bg-gray-50"
              >
